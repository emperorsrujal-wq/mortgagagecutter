    ...
    const sections = [
      {
        ...
        content: `In the ${selectedCountry} landscape, a bank is not a simple vault for your cash; it is a financial intermediary—a "Spread Merchant" that survives entirely on the gap between what it pays you and what it charges others. When you walk into a branch of ${country.majorBanks[0]}, you are technically granting the institution an unsecured loan of your ${country.currencyCode}. Under the rigorous oversight of the ${country.regulator}, the bank is legally permitted to use your deposit as the "Raw Material" for its own lending operations. It is a licensed entity designed to capture your capital at the lowest possible cost so it can sell that same energy back to the community at a significantly higher interest rate in the form of credit cards or mortgages.`
      },
      {
        title: "02. The Checking Account (The Transaction Hub)",
        icon: <Zap className="h-6 w-6 text-emerald-500" />,
        content: `The checking account is the primary Transaction Hub of your financial engine, engineered by players like ${country.majorBanks[1]} for high-frequency movement and maximum friction. Because modern life in hubs like ${country.cities[0]} requires constant spending, the bank offers this "convenience" typically for free or a nominal fee while paying you zero interest. They do this because checking accounts provide them with a constant, high-velocity stream of "Free Capital." By keeping your liquidity in a checking account, you are providing the bank with an interest-free loan that they use to meet their reserve requirements while you handle the daily friction of bills and lifestyle expenses.`
      },
      {
        title: "03. The Savings Account (The Liquidity Bucket)",
        icon: <Coins className="h-6 w-6 text-amber-500" />,
        content: `Marketed as your "Safety Bucket," the savings account offers a symbolic interest rate, currently around ${country.rates.savings}. In reality, this rate is intentionally set just high enough to discourage you from moving your capital to a competitor, but rarely high enough to beat the silent erosion of inflation. It is a "Holding Pen" for your idle cash. While your balance at ${country.majorBanks[0]} looks stable on a screen, the purchasing power of that money is eroding as the ${country.centralBank} manages the national debt of ${country.nationalDebt}. Keeping large sums in a "safe" savings account is a guaranteed way to lose wealth relative to the cost of living in ${selectedCountry} over any meaningful time horizon.`
      },
      {
        title: "04. Term Deposits: ${termDeposit}s (The Time Lock)",
        icon: <Clock className="h-6 w-6 text-purple-500" />,
        content: `For those seeking "Guaranteed Safety," banks offer ${termDeposit}s—the ultimate Time Lock for your capital. In a ${termDeposit}, you legally agree to freeze your ${country.currencyCode} for a fixed period, typically 1 to 5 years. In exchange for surrendering your liquidity, ${country.majorBanks[1]} pays a slightly higher interest rate than a savings account. This is a massive win for the bank's balance sheet: they secure long-term, predictable capital that they can leverage into 30-year mortgages, knowing you cannot withdraw it without a heavy penalty. You have traded your most valuable asset—your flexibility—for a nominal return that often barely keeps pace with the cost of living in ${selectedCountry}.`
      },
      {
        title: "05. Strategic Pitfalls & The Inflation Siphon",
        icon: <ShieldAlert className="h-6 w-6 text-red-500" />,
        content: `The greatest risk in the ${selectedCountry} banking machine isn't a sudden bank run—it's the silent siphon of inflation. While your balance at ${country.majorBanks[1]} might look stable on a screen, the ${country.centralBank} prioritizes institutional stability over your personal net worth. If the inflation rate is higher than your savings rate, you are effectively paying the bank to lose money every single day. By keeping your money "Siloed" in low-yield accounts while carrying high-interest debt, you are creating an "Interest Gap" that transfers your future labor directly to the bank's shareholders.`
      },
      {
        title: "06. The Strategic Action Plan (Sovereignty)",
        icon: <Target className="h-6 w-6 text-purple-500" />,
        content: `To move from "Consumer" to "Strategist," you must audit your relationship with ${country.majorBanks[0]}. Start by questioning why your money is siloed in accounts that benefit the bank's balance sheet more than yours. Shift your focus from "Saving" to "Velocity"—ensuring every ${country.currencyCode} of your income hits your highest-interest debt immediately to neutralize the daily interest calculations regulated by the ${country.regulator}. Your goal is to move from being the "Fuel" of the bank's machine to being the "Owner" of your own capital flow, using their products only when they serve your specific speed of payoff.`
      }
    ];
  ...
  const renderGovernmentDeepDive = (country: CountrySpecificInfo) => {
    const sections = [
      ...
      },
      {
        ...
        content: `The ${country.taxAgency} is the primary fuel for the state machine. In ${selectedCountry}, taxation is not a single bill, but a multi-layered capture system. "Income Tax" is a progressive levy on your production—the more value you provide, the higher the percentage the state captures. "Consumption Tax" (like GST or Sales Tax) captures revenue every time money moves through the economy in cities like ${country.cities[1]}. "Property Tax" is a recurring storage fee on your home equity. The engine is relentless, designed to capture energy at every point of the economic cycle. However, the ${country.taxAgency} also provides "Safety Valves"—legal ways to keep more of your money through strategic deductions.`
      },
      {
  ...
  const renderFamilyDeepDive = (country: CountrySpecificInfo) => {
    const sections = [
      ...
      },
      {
        ...
        icon: <Zap className="h-6 w-6 text-amber-400" />,
        content: `To build mastery, children need practical experience with real-world tools. The "Allowance" should be viewed as a "Management Training Tool"—not a gift. It should be tied to household responsibilities and allocated across their three buckets. "Kids' Accounts" at ${country.majorBanks[0]} are the "Storing Energy Bunkers," where they can watch their first few ${country.currencyCode} earn interest. Modern savings apps in ${country.cities[2]} serve as "Digital Dashboards," helping them visualize their progress toward goals. Each tool should be introduced as a way to manage family energy more efficiently under ${country.regulator} standards.`
      },
      {
  ...
  const renderMortgageDeepDive = (country: CountrySpecificInfo) => {
    const sections = [
      ...
      },
      {
        ...
        icon: <Zap className="h-6 w-6 text-amber-400" />,
        content: `Home loans in ${selectedCountry} come in three primary structures. "Fixed Rate" mortgages offer the "Certainty Premium"—you pay a higher price for the peace of mind of a static payment. "Variable" or "Adjustable" rates are the "Market Mirror"—they reflect ${country.centralBank} policy changes instantly, often making them more volatile but potentially cheaper over the long run. "Strategic" tools like HELOCs or Offset accounts are the "Strategic Valves"—they allow you to deposit income directly against principal, dropping the interest charges instantly. Choosing the right tool is the difference between 30 years of labor and 10.`
      },
      {
        title: "04. The Equity Trap vs. Liquidity (Dead Assets)",
        icon: <Waves className="h-6 w-6 text-amber-400" />,
        content: `In ${selectedCountry}, "Home Equity" is often a "Dead Asset." It is money trapped inside your walls that you cannot spend without permission and another fee from ${country.majorBanks[1]}. By utilizing a ${country.productName || 'HELOC'}, you can keep your capital liquid and accessible while still using it to reduce your mortgage interest. The goal is "Capital Efficiency"—ensuring your money works to reduce your total liability without losing access to it for emergencies in cities like ${country.cities[1]} or opportunities in the ${country.stockExchanges[0]}.`
      },
      {
        title: "05. Strategic Refinancing & Renewals (The Stress)",
        icon: <ShieldAlert className="h-6 w-6 text-red-400" />,
        content: `The greatest risk in the ${selectedCountry} mortgage market is the "Renewal or Reset Trap." In markets like Canada or the UK, mortgages renew every few years, exposing you to the current prime rate of ${country.rates.prime}. You must move beyond being a passive borrower and become a "Lender Analyst." Perform a "Stress Test" on your family's finances to see how a significant rate hike would impact your cash flow in cities like ${country.cities[2]} before your next renewal cycle occurs. Being prepared is the only way to maintain sovereignty over your home.`
      },
      {
