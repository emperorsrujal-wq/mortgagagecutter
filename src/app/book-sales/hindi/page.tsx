      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-gray-900 text-white p-8 rounded-2xl shadow-2xl">
          <div className="text-center md:text-left">
            ...
            {bookCoverImage && (
              <div className="mt-6 md:hidden">
                <img src={bookCoverImage.imageUrl} alt="LOAN KILLERS Book Cover" width="400" height="600" className="rounded-lg shadow-lg mx-auto" />
              </div>
            )}
          ...
          <div className="hidden md:block">
            {bookCoverImage && (
              <img src={bookCoverImage.imageUrl} alt="LOAN KILLERS Book Cover" width="400" height="600" className="rounded-lg shadow-2xl" />
            )}
          </div>
        </div>
