            ...
            {isLocked ? (
              ...
              <div className="space-y-20">
                ...
                <section className="space-y-16">
                  ...
                  <div className="space-y-10 leading-relaxed text-2xl text-[#334155] font-medium">
                    <p>
                      <TranslatedText>{`To execute the Mortgage Cutter Method, you must perform a radical audit of your relationship with your financial institution. You are not a petitioner asking for a favor; you are a customer searching for specific "Debt Inventory" that features the strategic tools we require.`}</TranslatedText>
                    </p>
                    
                    <p>
                      <TranslatedText>{`Most retail bank products are designed as "One-Way Streets." Money flows in, but it's locked behind a wall of equity that you can't touch without a new loan application. We require a "Two-Way Street"—a strategic valve that allows your income to flow in and out without friction, while recalculating interest every single night.`}</TranslatedText>
                    </p>
                    ...
                    <div className="p-12 bg-slate-50 rounded-[56px] border-4 border-indigo-100 space-y-12 shadow-inner">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                          {[
                            { num: "01", title: "Daily Recalculation", desc: "The bank must calculate interest on the REMAINING balance every 24 hours. Without this, Lesson 2's neutralization fails entirely." },
                            { num: "02", title: "Auto-Readvanceable", desc: "As you pay down principal, your credit limit should grow automatically. This is your 'Two-Way Street' for liquidity." },
                            { num: "03", title: "Full Transactionality", desc: "The account must support direct deposit and standard bill pay. It is not a secondary loan; it is your new Transaction Hub." }
                          ].map((item, i) => (
                  ...
                  <div className="p-12 bg-indigo-900 text-white rounded-[64px] border border-white/10 shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-12 opacity-10">
                      <Search className="h-64 w-64" />
                    </div>
                    <div className="relative z-10 space-y-8">
                      <h3 className="text-4xl font-fraunces font-black text-blue-300"><TranslatedText>Bypassing the Sales Desk</TranslatedText></h3>
                      <div className="space-y-6 text-xl text-indigo-100 leading-relaxed font-medium">
                        <p>
                          <TranslatedText>{`Standard 'Loan Officers' at local branches are trained to sell 30-year fixed mortgages because they are high-profit for the bank. If you ask for a 'HELOC', they will assume you want a second mortgage—which is NOT the strategy.`}</TranslatedText>
                        </p>
                        <p className="bg-white/10 p-8 rounded-[32px] border border-white/20 italic">
                          <TranslatedText>{`Pro Tip: Ask to speak with the 'Private Wealth Management' or 'Custom Lending' department. These specialists deal with high-net-worth clients who already use these 'Open System' strategies to manage their capital efficiency.`}</TranslatedText>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-10">
                      ...
                      <p className="text-2xl text-[#334155] leading-relaxed font-medium">
                          <TranslatedText>{`Use these specific questions to filter out lenders in under 5 minutes. If they can't answer 'Yes' to all three, they are selling a trap. Hang up.`}</TranslatedText>
                      </p>
                  ...
                  <CaseStudy 
                    name="Michael T. (Calgary, AB)"
                    savings="Bank Replaced"
                    timeline="2 Weeks Setup"
                    quote="I called three banks. The first two told me what I wanted was impossible. The third one—a credit union—knew exactly what I meant by 'First-Lien Revolving Line'. The difference in their technical knowledge was night and day."
                  />

                  <div className="pt-16 text-center space-y-10">
                    <div className="inline-flex items-center gap-4 px-8 py-3 bg-indigo-50 text-indigo-600 rounded-full text-xs font-black uppercase tracking-[0.4em] border border-indigo-100 shadow-sm">
                      <ShieldCheck className="h-5 w-5" />
                    ...
                    <p className="text-slate-500 text-2xl max-w-xl mx-auto font-medium italic">
                      <TranslatedText>In the final lesson, we map out your first 90 days. From the 'Liquidity Injection' to the 'Maintenance Loop', this is your step-by-step roadmap to freedom.</TranslatedText>
                    </p>
                    <button 
                      onClick={nextLesson}
            ...
            {isLocked ? (
              <section className="bg-white p-20 rounded-[80px] border-4 border-dashed border-slate-200 text-center space-y-12 shadow-inner">
                  ...
                  <div className="space-y-8">
                      ...
                      <p className="text-slate-500 text-2xl max-w-xl mx-auto font-medium leading-relaxed italic">
                          <TranslatedText>{`The final module is reserved for our Premium Members. Join the movement and reclaim your future.`}</TranslatedText>
                      </p>
                  </div>
                  <div className="pt-10 space-y-8">
                      <Button size="lg" className="w-full sm:w-auto px-20 py-12 text-3xl font-black rounded-[32px] shadow-2xl shadow-blue-500/30 transition-all hover:scale-105 active:scale-95" asChild>
                          <Link href="/purchase?plan=pro_197">
                              <TranslatedText>Unlock Final Roadmap</TranslatedText>
                              <ArrowRight className="ml-4 h-10 w-10" />
                          </Link>
                      </Button>
                  </div>
